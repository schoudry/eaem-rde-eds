...
## Environments
- Preview: https://main--eaem-rde-eds--schoudry.aem.page/
- Live: https://main--eaem-rde-eds--schoudry.aem.live/
...
1. Open the `eaem-rde-eds` directory in your favorite IDE and start coding :)
